<template>
    ...
    <div class="landing-info">
      ...
      <h1 class="landing-info-title">PayKing</h1>
      <p class="landing-info-text">Multi-platform platform for outdoor mobility, completely invisible ть without посредников!</p>
